...
import com.kitaotao.sst.services.engineering.engineering_service_1
import com.kitaotao.sst.services.engineering.engineering_service_2
import com.kitaotao.sst.setDynamicHeader
import isDeviceTabletClickPop
import officeViewChange
import showClickPopAnimation

class MunicipalEngineeringOffice : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        videoUri = Uri.parse("android.resource://${packageName}/raw/kitaotao_2nd_floor_model_engineering")
