...
class MunicipalAgricultureOffice : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        videoUri = Uri.parse("android.resource://${packageName}/raw/kitaotao_1st_floor_model_agriculture")
        ...
        overlayImage.setImageResource(R.drawable.magro256)  // Replace with your image resource
