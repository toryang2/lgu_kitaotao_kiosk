...
import com.kitaotao.sst.services.mayors.mayors_service_1
import com.kitaotao.sst.services.mayors.mayors_service_2
import com.kitaotao.sst.setDynamicHeader
import isDeviceTabletClickPop
import officeViewChange
import showClickPopAnimation

class MunicipalMayorOffice : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        videoUri = Uri.parse("android.resource://${packageName}/raw/kitaotao_2nd_floor_model_mayor")
        ...
        overlayImage.setImageResource(R.drawable.mayors256)  // Replace with your image resource
