...
// Define GeoPoints for the markers
        val firstMarkerPoint = GeoPoint(7.640719, 125.008417) // First marker position
...
// Optional: Display info windows
        ...
        overlayImage.setImageResource(R.drawable.watersystem256)  // Replace with your image resource
        ...
        setClickListener(R.id.ex_service_1, water_ex_service_1::class.java)
        setClickListener(R.id.in_service_1, water_in_service_1::class.java)
        setClickListener(R.id.in_service_2, water_in_service_2::class.java)
    }
