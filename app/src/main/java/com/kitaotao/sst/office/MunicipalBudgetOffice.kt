...
import com.kitaotao.sst.services.budget.budget_service_1
import com.kitaotao.sst.services.budget.budget_service_2
import com.kitaotao.sst.setDynamicHeader
import isDeviceTabletClickPop
import officeViewChange
import showClickPopAnimation

class MunicipalBudgetOffice : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        overlayImage.setImageResource(R.drawable.budget256)  // Replace with your image resource
